...
# from . import generator as g, project as p, PROJECT_ROOT
...
#
# def defaults(glyph: GlyphBuilder):
#     '''Sets defaults for each glyph, run with GlyphBuilder.do(..)'''
#     glyph.set_unlink_overlap_on_save() \
#         .comment('AUTOGENERATED DO NOT EDIT')
#
#     glyph.glyph.removeOverlap()
#
# def static_gen(font: Font):
#     '''Modifies the font'''
#
#     for i in range(g.BLOCK_COUNT + 1):
#         font.glyph().name(g.BBLOCK + str(i)) \
#                     .clear() \
#                     .outline(g.ASSETS_DIR / g.NAME_FORMAT.format(index=i)) \
#                     .width(0) \
#                     .color(0xf22929)
#
#     ## LETTERS ##
...
#                     .color(0xf22929)
#
#     if p.Options.BLOCKSPACE in options:
